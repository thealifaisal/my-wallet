...
class DailyWidget extends StatefulWidget {
  ...
  DailyWidget({this.date, this.month, this.year, this.income, this.expense});

  @override
  DailyWidgetState createState() => DailyWidgetState();
}

class DailyWidgetState extends State<DailyWidget> {
  @override
